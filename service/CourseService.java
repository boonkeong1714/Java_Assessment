...
public class CourseService {
    ...
    //usage not found
    //BK: moved to show Courses Summary
...
//    }
    ...
    public void showSummary() {
        ...
        System.out.println("There are " + courses.size() + " course(s) available.");
//        System.out.println( "Available Courses:" );
        ...
        //BK: if no students enrolled in any courses
        if (enrolledStudents.size() == 0) {
            System.out.println( "No student enrolled any courses." );
        }
